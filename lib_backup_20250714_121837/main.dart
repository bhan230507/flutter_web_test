...
class _MainHomePageState extends State<MainHomePage>
  ...
  final List<String> tabs = ['사람사주', '개사주'];
  final List<Map<String, dynamic>> chips = [
    {'label': '출석체크', 'icon': Icons.check_circle_outline},
    {'label': '복주머니 모으기', 'icon': Icons.card_giftcard},
    {'label': '운세상담', 'icon': Icons.chat_bubble_outline},
    {'label': '정통사주', 'icon': Icons.auto_stories},
    {'label': '신년운', 'icon': Icons.calendar_today},
    {'label': '행운코디', 'icon': Icons.style},
    {'label': '행운골프', 'icon': Icons.golf_course},
  ];
  final List<Map<String, dynamic>> navItems = [
    {'label': '점신', 'icon': Icons.assignment},
    {'label': '2025 운세', 'icon': Icons.brightness_5},
    {'label': '타로', 'icon': Icons.local_cafe},
    {'label': '상담', 'icon': Icons.chat},
    {'label': '점신몰', 'icon': Icons.storefront},
  ];
  ...
  final List<Map<String, dynamic>> humanMenus = [
    ...
    },
    {
      ...
      'title': '복주머니 모으기',
      'subtitle': '행운의 복주머니 이벤트'
    },
    {
      'icon': Icons.chat_bubble_outline,
      'title': '운세상담',
      'subtitle': '전문가와 1:1 상담'
    },
    ...
    {'icon': Icons.golf_course, 'title': '행운골프', 'subtitle': '골프운세'},
  ];
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Icon(Icons.account_circle, color: Colors.black87, size: 20),
                ],
              ),
            ),
